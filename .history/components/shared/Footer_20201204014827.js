                ...
                <Row className='mt-3' style={{ textAlign: 'center', color: 'black' }}>
                    ...
                    <Col md='8'>
                        <Row>
                            <Col md='2'>
                                <div>
                                    <a target='_blank' className='footer-text' href='https://www.linkedin.com/in/rushank-shah-65836b1a6/'>
                            ...
                            <Col md='2'>
                                <div>
                                    <a target='_blank' className='footer-text' href='https://www.instagram.com/rushankshah65/'>
                            ...
                            <Col md='2'>
                                <div>
                                    <a target='_blank' className='footer-text' href='https://github.com/rushankshah'>
                            ...
                            <Col md='2'>
                                <div>
                                    <a target='_blank' className='footer-text' href='https://twitter.com/ShahRushank'>
                            ...
                            <Col md='2'>
                                <div>
                                    <a target='_blank' className='footer-text' href='https://dev.to/rushankshah'>
                            ...
                            <Col md='2'>
                                <div>
                                    <a target='_blank' className='footer-text' href='https://rushankshah65.medium.com/'>
                                        <i class="lni lni-medium lni-lg lni-32 social-media"><span className='footer-text'>Medium</span></i>
                                    </a>
                                </div>
                            </Col>
                        </Row>
